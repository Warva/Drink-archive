...
public class PoistaOmatunnus extends HttpServlet { 
...
public void service(HttpServletRequest req, HttpServletResponse res) 
	...
	taso = (Integer) session.getAttribute("taso");
      ...
      out.println("</div></body></html>");
   	...
   	PreparedStatement pstm = null;
		...
		try { 
	  	...
	  	// Poistetaan käyttäjän oma tunnus	
		
			String salasana_apu = req.getParameter("salasana_apu");
			String kayttaja_apu = req.getParameter("kayttaja_apu");

      	stm = con.prepareStatement(varmistus);  
      ...
      if (kayttaja_apu.equals(kayttaja) && salasana_apu.equals(salasana)){
      	pstm = con.prepareStatement(kayttajanpoisto);  
      	pstm.setInt(1,ktunnus);
      	pstm.executeUpdate();
      ...
      out.println("<p><input type=\"submit\" value=\"Sis&auml;&auml;n\" /></p></form></div>");
		...
		out.println("<div class=\"main\"><h1>Tervetuloa drinkkiarkistoon</h1>");
      out.println("<p class=\"keskitetty\">Poistit tunnuksesi.</p></div></body></html>");
      return;
      ...
      out.println("<p class=\"keskitetty\">Tunnuksen poistaminen ep&auml;onnistui.</p>");
